...
void recolectar_piedra(char archivo[y_arreglo][x_arreglo], recurso pedreria[tam_recurso])
{
	...
	if (recolectando)
	{
		...
		{
			indice = buscar_recurso((obrero.x + ANCHOPERSONAJE - 1) / 40, y_mapa, pedreria);
			tiempo_actual = time(NULL);
			if (tiempo_actual - tiempo_ultima_recoleccion >= 2)
			{
				contador_piedra = contador_piedra + 5;
		...
		{
			indice = buscar_recurso(x_mapa, (obrero.y + ALTOPERSONAJE - 1) / 40, pedreria);
			tiempo_actual = time(NULL);
			if (tiempo_actual - tiempo_ultima_recoleccion >= 2)
			{
				contador_piedra = contador_piedra + 5;
		...
		{
			indice = buscar_recurso((obrero.y + ALTOPERSONAJE - 1) / 40, (obrero.x + ANCHOPERSONAJE - 1) / 40, pedreria);
			tiempo_actual = time(NULL);
			if (tiempo_actual - tiempo_ultima_recoleccion >= 2)
			{
				contador_piedra = contador_piedra + 5;
...
void recolectar_madera(char archivo[y_arreglo][x_arreglo], recurso bosque[tam_recurso])
{
	...
	if (recolectando)
	{
		...
		{
			indice = buscar_recurso((obrero.x + ANCHOPERSONAJE - 1) / 40, y_mapa, bosque);
			tiempo_actual = time(NULL);
			if (tiempo_actual - tiempo_ultima_recoleccion >= 2)
			{
				contador_madera = contador_madera + 5;
		...
		{
			indice = buscar_recurso(x_mapa, (obrero.y + ALTOPERSONAJE - 1) / 40, bosque);
			tiempo_actual = time(NULL);
			if (tiempo_actual - tiempo_ultima_recoleccion >= 2)
			{
				contador_madera = contador_madera + 5;
		...
		{
			indice = buscar_recurso((obrero.x + ANCHOPERSONAJE - 1) / 40, (obrero.y + ALTOPERSONAJE - 1) / 40, bosque);
			tiempo_actual = time(NULL);
			if (tiempo_actual - tiempo_ultima_recoleccion >= 2)
			{
				contador_madera = contador_madera + 5;
